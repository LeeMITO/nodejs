...
let db;
MongoClient.connect('mongodb+srv://admin:right1234@cluster0.tl8dxz3.mongodb.net/?retryWrites=true&w=majority', function (error, client) {
...
app.post('/add', function (req, res) { 
  ...
  db.collection('counter').findOne({ name: '게시물갯수' }, function (error, result) { 
    ...
    db.collection('post').insertOne({ _id : totalPostingCount, 제목: req.body.title, 날짜: req.body.date }, function (error, result) { 
      console.log('저장완료');
